    ...
    <nav className="bg-red-500 px-6 py-4 shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="hidden space-x-6 md:flex">
          <Link to="/view-profile" className="text-white hover:underline">View Profile</Link>
          <Link to="/tokens" className="text-white hover:underline">Tokens</Link>
          <Link to="/food-menu" className="text-white hover:underline">Food & Menu</Link>
          <Link to="/feedback-complaint" className="text-white hover:underline">Feedback & Complaint</Link>
          <Link to="/voting" className="text-white hover:underline">Voting</Link>
